...
//	
//	std::cout << KTR::HASH::FNV_1A<void(*)(const TestEvent&), std::uint32_t>::Hash(&Listner1::TOTO);
//
...
struct toto<T*>
{};
//#define KTR_DISABLE_DEFAULT_HASH
#include "Tools/Hash/KTR_Hasher.h"

template< typename  HashBits> 
struct totorigolo
{

	using hash_type = int;
	using return_hash_type = HashBits;
	/**
